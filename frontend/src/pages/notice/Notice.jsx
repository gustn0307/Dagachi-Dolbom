...
const faqItems = [
  {
  q: "다같이 돌봄은 어떤 서비스인가요?",
  a: "돌봄이 필요한 이웃을 제보하고, 지역 주민이 안부 확인 활동에 참여할 수 있도록 연결하는 지역사회 돌봄 서비스입니다. 활동 결과는 담당 기관이 확인합니다.",
},
  {
  ...
  {
  q: "여러 명이 함께 참여하는 활동은 기록도 각각 작성하나요?",
  a: "아니요. 같은 활동에 참여한 봉사자는 하나의 공동 활동기록을 함께 사용합니다. 한 참여자가 활동을 시작하면 다른 승인 참여자도 같은 공동 기록을 사용합니다.",
},
  {
